...
public class SearchPresenter extends Presenter<SearchView> implements
    ...
    private class SongFilterOperator implements SingleOperator<List<ViewModel>, List<Song>> {
        ...
        SearchHeaderView songsHeader = new SearchHeaderView(new Header(LemonApplication.getInstance().getString(R.string.tracks_title)));
    ...
    private class AlbumFilterOperator implements SingleOperator<List<ViewModel>, List<Album>> {
        ...
        SearchHeaderView albumsHeader = new SearchHeaderView(new Header(LemonApplication.getInstance().getString(R.string.albums_title)));
    ...
    private class AlbumArtistFilterOperator implements SingleOperator<List<ViewModel>, List<AlbumArtist>> {
        ...
        SearchHeaderView artistsHeader = new SearchHeaderView(new Header(LemonApplication.getInstance().getString(R.string.artists_title)));
