...
public class UpNextView extends LinearLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        LemonApplication.getInstance().getAppComponent().inject(this);
        ...
        disposables.add(Observable.combineLatest(
                ...
                Aesthetic.get(getContext()).isDark().map(isDark -> LemonUtils.isLandscape() && !isDark),
        ...
        disposables.add(Aesthetic.get(getContext()).isDark()
                .map(isDark -> LemonUtils.isLandscape() && !isDark)
