...
public class AlbumView extends MultiItemView<AlbumView.ViewHolder, Album> implements SectionedView {
    ...
    public void bindView(final ViewHolder holder) {
        ...
        holder.overflowButton.setContentDescription(holder.itemView.getResources().getString(com.lemon.player.R.string.btn_options, album.name));
    ...
    public String getSectionName() {
        ...
        switch (sortOrder) {
            case com.lemon.player.utils.SortManager.AlbumSort.DEFAULT:
                string = StringUtils.keyFor(album.name);
                break;
            case com.lemon.player.utils.SortManager.AlbumSort.NAME:
                string = album.name;
                break;
            case com.lemon.player.utils.SortManager.AlbumSort.ARTIST_NAME:
                string = album.albumArtistName;
                break;
            case com.lemon.player.utils.SortManager.AlbumSort.YEAR:
