...
public class LegacyDatabaseUtils {
    ...
    public static BriteDatabase getBlacklistDatabase() {
        return new SqlBrite.Builder().build()
                .wrapDatabaseHelper(new BlacklistDbOpenHelper(LemonApplication.getInstance()), Schedulers.io());
    }
    ...
    public static BriteDatabase getWhitelistDatabase() {
        return new SqlBrite.Builder().build()
                .wrapDatabaseHelper(new WhitelistDbOpenHelper(LemonApplication.getInstance()), Schedulers.io());
    }
