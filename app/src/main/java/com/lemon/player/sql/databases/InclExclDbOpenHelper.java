...
public class InclExclDbOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        LemonApplication.getInstance().deleteDatabase(BlacklistDbOpenHelper.DATABASE_NAME);
        LemonApplication.getInstance().deleteDatabase(WhitelistDbOpenHelper.DATABASE_NAME);
    }
