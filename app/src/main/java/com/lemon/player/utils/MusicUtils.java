...
public class MusicUtils {
    ...
    public static void playAll(List<Song> songs, int position, boolean canClearShuffle, UnsafeConsumer<String> onEmpty) {
        ...
        if (songs.size() == 0
            ...
            onEmpty.accept(LemonApplication.getInstance().getResources().getString(R.string.empty_playlist));
            return;
        }
    ...
    public static void addToQueue(List<Song> songs, UnsafeConsumer<String> onAdded) {
        ...
        onAdded.accept(LemonApplication.getInstance().getResources().getQuantityString(R.plurals.NNNtrackstoqueue, songs.size(), songs.size()));
    }
