...
public final class LemonUtils {

    //Arguments supplied to various bundles

    private final static String TAG = "LemonUtils";

    @NonNull
    public static Intent getLemonStoreIntent(@NonNull String packageName) {
        String uri;
        if (isAmazonBuild()) {
    ...
    @NonNull
    public static Intent getLemonWebIntent(@NonNull String packageName) {
        String uri;
    ...
    public static void openShuttleLink(@NonNull Activity activity, @NonNull String packageName, PackageManager packageManager) {
        Intent intent = getLemonStoreIntent(packageName);
        if (packageManager.resolveActivity(intent, 0) == null) {
            intent = getLemonWebIntent(packageName);
        }
    ...
    public static boolean isOnline(boolean careAboutWifiOnly) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(LemonApplication.getInstance());
        ...
        final ConnectivityManager cm = (ConnectivityManager) LemonApplication.getInstance()
    ...
    public static boolean isUpgraded() {
     ...
     /*   if (LemonApplication.getInstance().getIsUpgraded()) {
            return true;
        }
        ...
        try {
            return LemonApplication.getInstance().getPackageName().equals(Config.PACKAGE_NAME_PRO);
...
*/
    ...
    public static boolean isLandscape() {
        final int orientation = LemonApplication.getInstance().getResources().getConfiguration().orientation;
        return orientation == Configuration.ORIENTATION_LANDSCAPE;
    }

    public static boolean isTablet() {
        return LemonApplication.getInstance().getResources().getBoolean(R.bool.isTablet);
    }
    ...
    public static String getIpAddr() {
        ...
        int i = ((WifiManager) LemonApplication.getInstance().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo().getIpAddress();
