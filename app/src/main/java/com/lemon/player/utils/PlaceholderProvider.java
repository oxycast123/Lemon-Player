...
public class PlaceholderProvider {
    ...
    private PlaceholderProvider() {
        final Resources res = LemonApplication.getInstance().getResources();
        ...
        Aesthetic.get(LemonApplication.getInstance()).isDark()
    ...
    public Drawable getPlaceHolderDrawable(@Nullable String displayName, boolean large) {
        ...
        if (!TextUtils.isEmpty(displayName) && SettingsManager.getInstance().useGmailPlaceholders()) {
            ...
            drawable = ContextCompat.getDrawable(LemonApplication.getInstance(), large ? getLargePlaceHolderResId() : getMediumPlaceHolderResId());
        }
        return drawable;
    }
}
