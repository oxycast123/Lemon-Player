            ...
            switch (typeface) {
                ...
                case SANS_SERIF_MEDIUM:
                    if (LemonUtils.hasLollipop()) {
                        ...
                        result = Typeface.createFromAsset(LemonApplication.getInstance().getAssets(), "fonts/" + ROBOTO_MEDIUM);
                    }
                    break;
                case SANS_SERIF_LIGHT:
                    ...
                    break;
                default:
                    result = Typeface.createFromAsset(LemonApplication.getInstance().getAssets(), "fonts/" + typeface);
                    break;
            }
