...
public class ArtworkDialog {
    ...
    public static MaterialDialog build(Context context, ArtworkProvider artworkProvider) {
        ...
        UserSelectedArtwork userSelectedArtwork = LemonApplication.getInstance().userSelectedArtwork.get(artworkProvider.getArtworkKey());
        ...
        return new MaterialDialog.Builder(context)
                ...
                .onPositive((dialog, which) -> {
                    ...
                    if (checkedView != null) {
                        ...
                        LemonApplication.getInstance().userSelectedArtwork.put(artworkProvider.getArtworkKey(), new UserSelectedArtwork(artworkModel.type, artworkModel.file == null ? null : artworkModel.file.getPath()));
                    } else {
                        ...
                        LemonApplication.getInstance().userSelectedArtwork.remove(artworkProvider.getArtworkKey());
                    }
                    dialog.dismiss();
                })
                ...
                .onNeutral((dialog, which) -> RxImagePicker.with(context)
                        ...
                        .flatMap(uri -> {
                            ...
                            File dir = new File(LemonApplication.getInstance().getFilesDir() + "/shuttle/custom_artwork/" + artworkProvider.getArtworkKey().hashCode() + "/");
