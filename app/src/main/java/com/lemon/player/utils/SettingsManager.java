...
public class SettingsManager {
    ...
    private SharedPreferences getSharedPreferences() {
        return PreferenceManager.getDefaultSharedPreferences(LemonApplication.getInstance());
    }
    ...
    public int getAlbumDisplayType() {
        return getInt(KEY_ALBUM_DISPLAY_TYPE, LemonUtils.isTablet() ? ViewType.ALBUM_PALETTE : ViewType.ALBUM_LIST);
    }
    ...
    private String getArtistColumnCountKey() {
        ...
        if (LemonUtils.isLandscape()) {
            key = LemonUtils.isTablet() ? KEY_ARTIST_COLUMN_COUNT_TABLET_LAND : KEY_ARTIST_COLUMN_COUNT_LAND;
        } else {
            if (LemonUtils.isTablet()) key = KEY_ARTIST_COLUMN_COUNT_TABLET;
        }
    ...
    private String getAlbumColumnCountKey() {
        ...
        if (LemonUtils.isLandscape()) {
            key = LemonUtils.isTablet() ? KEY_ALBUM_COLUMN_COUNT_TABLET_LAND : KEY_ALBUM_COLUMN_COUNT_LAND;
        } else {
            if (LemonUtils.isTablet()) key = KEY_ALBUM_COLUMN_COUNT_TABLET;
        }
