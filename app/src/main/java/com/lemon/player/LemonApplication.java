...
public class LemonApplication extends Application {
    ...
    public static synchronized LemonApplication getInstance() {
        return instance;
    }
    ...
    FirebaseAnalytics.getInstance(this);
        ...
        Completable.fromAction(() -> {
            ...
            SqlUtils.createActionableQuery(LemonApplication.this, cursor ->
 ...
 /*   public RefWatcher getRefWatcher() {
    ...
    protected AppComponent initDagger(LemonApplication application) {
    ...
    private Observable<List<Song>> cleanGenres() {
        ...
        return SqlBriteUtils.createSingleList(LemonApplication.getInstance(), Genre::new, Genre.getQuery())
