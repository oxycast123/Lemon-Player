...
public class Song implements
    ...
    public Single<Genre> getGenre() {
        ...
        return SqlBriteUtils.createSingle(LemonApplication.getInstance(), Genre::new, query, null);
    }
    ...
    public String getDurationLabel() {
        if (durationLabel == null) {
            durationLabel = StringUtils.makeTimeString(LemonApplication.getInstance(), duration / 1000);
        }
    ...
    public String getBitrateLabel() {
        if (bitrateLabel == null) {
            bitrateLabel = getTagInfo().bitrate + LemonApplication.getInstance().getString(R.string.song_info_bitrate_suffix);
        }
        return bitrateLabel;
    }
    ...
    public String getSampleRateLabel() {
        if (sampleRateLabel == null) {
            ...
            sampleRateLabel = ((float) sampleRate) / 1000 + LemonApplication.getInstance().getString(R.string.song_info_sample_rate_suffix);
        }
        return sampleRateLabel;
    }
