...
/**
 * This is a separate testing class than {@link LemonUtilsTest} as PowerMock and Robolectric
...
@PrepareForTest({PreferenceManager.class, LemonApplication.class, LemonUtils.class})
public class LemonUtilsPowerMockTest {

    @Test
    public void testIsOnlineWifiConnected() {
        LemonApplication mockApplication = mock(LemonApplication.class);
    ...
    public void testIsOnlineCellularConnected() {
        ...
        assertThat(LemonUtils.isOnline(true)).isFalse();
    ...
    public void testIsUpgraded() throws Exception {
        ...
        assertThat(LemonUtils.isUpgraded()).isTrue();
        ...
        assertThat(LemonUtils.isUpgraded()).isFalse();
    }
    ...
    public void testGetIpAddr() throws Exception {
        ...
        assertThat(LemonUtils.getIpAddr()).isEqualTo("192.168.1.1");
    }
}
